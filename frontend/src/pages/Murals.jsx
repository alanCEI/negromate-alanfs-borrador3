/**
 * Página de Murales - Muestra servicios de arte mural y galería de trabajos
 *
 * Esta página de categoría presenta:
 * - Galería en grid de murales realizados
 * - Modal para ver imágenes ampliadas al hacer clic
 * - Paquetes de precios para servicios de murales
 ...
 *
 * Página de categoría para servicios de murales que muestra:
 * - Galería en cuadrícula de murales realizados
 * - Modal interactivo para ampliar imágenes
 * - Paquetes de servicios disponibles
 */
const Murals = () => {
    // Estado para almacenar los productos/paquetes de murales
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                // Llamada a la API para obtener productos y galería de la categoría 'Murals'
    ...
    if (loading) return <div className="loading-message">Cargando murales...</div>;
                    ...
                    {/* Grid de imágenes de galería */}
                     <div className="murals-gallery-grid">
                        {gallery.map(item => (
                            ...
                            <div key={item.id} className="murals-gallery-item" onClick={() => setModalImage(item.imageUrl)}>
                                <img src={item.imageUrl} alt={item.title} className="murals-gallery-item-image" />
