...
export const mockData = {
    ...
    products: [
        ...
        // Paquetes de identidad de marca y diseño corporativo
        {
            ...
            details: ['Diseño de logotipo principal', 'Paleta de colores y tipografías', '2 rondas de revisión', 'Archivos en formato vectorial y PNG']
        },
        {
            category: 'GraphicDesign',
            ...
            details: ['Todo del Paquete Esencial', 'Diseño de logotipo secundario y favicon', 'Manual de marca básico (4 páginas)', 'Diseño de tarjeta de visita', '4 rondas de revisión']
        },
        {
            category: 'GraphicDesign',
        ...
        // Servicios de customización de prendas con diseños únicos
        {
            ...
            details: ['1 prenda (camiseta o sudadera)', 'Diseño personalizado (hasta 2 colores)', 'Técnica de serigrafía o vinilo textil', 'Asesoría de diseño incluida']
        },
        {
            category: 'CustomClothing',
            ...
            description: 'Perfecto para parejas, amigos o para tener una de recambio.',
            details: ['2 prendas a elección', 'Diseño complejo (hasta 4 colores)', 'Técnicas mixtas (aerografía, serigrafía)', 'Proceso colaborativo de diseño']
        },
        {
            category: 'CustomClothing',
        ...
        // Proyectos de arte urbano y decoración de espacios
        {
            ...
            details: ['Diseño y boceto digital', 'Superficie hasta 4 metros cuadrados', 'Pintura plástica y sprays de alta calidad', 'Trabajo realizado en 1-2 días']
        },
        {
            category: 'Murals',
            ...
            description: 'Transforma un espacio comercial o una fachada (hasta 10m²).',
            details: ['Todo del Paquete Pequeño', 'Superficie hasta 10 metros cuadrados', 'Mayor complejidad y detalle en el diseño', 'Barniz protector anti-graffiti y UV']
        },
        {
            category: 'Murals',
            ...
            description: 'Proyectos de gran escala para un impacto urbano masivo (más de 10m²).',
    ...
    galleryImages: {
        ...
        graphicDesign: [
            ...
            { id: 3, brand: 'Caribes', imageUrl: '/images/caribes-bg.webp', description: 'Inspirados en las calles de Caracas. Observamos la sinergia entre el ciudadano y su transporte diario...' },
        ...
        customClothing: [
            ...
            { id: 3, title: 'Texturas Urbanas', imageUrl: '/images/clothes.webp', description: 'Capas de arte y moda.' },
            { id: 4, title: 'Rayo Lab Merch', imageUrl: '/images/rayolab-gorra.webp', description: 'Gorras con estilo.' },
        ...
        murals: [
            ...
            { id: 3, title: 'Con Las Manos', imageUrl: '/images/manos-pizza.webp', description: 'Pizzería con un toque radical.' },
            { id: 4, title: 'Media Luna', imageUrl: '/images/media-luna.webp', description: 'Decoración navideña en cristalera.' },
            { id: 5, title: 'El Refugio, Madrid', imageUrl: '/images/el-refugio.webp', description: 'La mirada del lobo en un refugio de montaña.' },
            { id: 6, title: 'Sancho Abarca, Zaragoza', imageUrl: '/images/sancho-abarca.webp', description: 'Un zorro lleno de color en el paisaje de Zaragoza.' }
        ]
    }
};
